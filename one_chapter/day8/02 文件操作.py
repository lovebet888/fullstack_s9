...
#对于w:没有此文件就会创建文件
# f = open('inputfile',mode='w',encoding='utf-8')
# f.write('骑兵步兵')
# f.close()
...
# f = open('inputfile',mode='wb')
# f.write('附近看到类似纠纷'.encode('utf-8'))
# f.close()

# f = open('inputfile',mode='a',encoding='utf-8')
# f.write('佳琪')
# f.close()
#
# f = open('inputfile',mode='a',encoding='utf-8')
...
# obj = open('inputfile',mode='r+',encoding='utf-8')
...
#         open('inputfile',mode='w+',encoding='utf-8') as f1:
